...
Переменные a, b и c произвольно размещены в регистрах $s0, $s1 и $s2. 
...
И 32-битные адреса слов, и 32-битные значения (англ.: data) на Рис. 6.1 записаны в шестнадцатеричной системе счисления.
